...
const ONBOARDING_CONTENT = [
  ...
  "   If profile details are missing, collect them with AskQuestionTool instead of a free-form checklist.",
...
const INSTRUCTIONS = [
  ...
  "",
  "Profile onboarding rule: when first-time profile fields are missing, ask for them with Claude Code's AskQuestionTool instead of a free-form checklist. Keep each question short and collect only the fields needed for shellmates_set_profile.",
  "",
